...
transfer_input_files=Fun4All_G4_Prototype4.C, build, Compile.sh, analysis
...
# and output.
Initialdir=/sphenix/user/zshi/2019sPHENIXAna/EMCAL/Simulations/macros/macros/prototype4/condor/directory

# Input file given to the job.
Input=/dev/null

# The job's stdout is sent to this file.
Output=/sphenix/user/zshi/2019sPHENIXAna/EMCAL/Simulations/macros/macros/prototype4/condor/out/job.$(Cluster).out
# The job's stderr is sent to this file.
Error=/sphenix/user/zshi/2019sPHENIXAna/EMCAL/Simulations/macros/macros/prototype4/condor/err/job.$(Cluster).err
# The condor log file for this job, useful when debugging.
Log=/sphenix/user/zshi/2019sPHENIXAna/EMCAL/Simulations/macros/macros/prototype4/condor/log/myjob.$(Cluster).log
