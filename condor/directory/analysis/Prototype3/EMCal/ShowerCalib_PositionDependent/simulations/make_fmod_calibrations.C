...
#include "../Proto3ShowerCalib.C"
#include "../Proto3ShowerCalibLinkDef.h"
...
void make_fmod_calibrations()
{
  ...
  TFile *f =TFile::Open("/gpfs/mnt/gpfs04/sphenix/user/zshi/2019sPHENIXAna/EMCAL/Simulations/macros/macros/prototype4/DSTReader.root");
